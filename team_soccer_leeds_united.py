"""
Leeds United FC — Player Headshot Downloader (Soccer / EPL)
...
Sources (tried in order per player):
  1. PL25 CDN      — resources.premierleague.com/premierleague25/110x140 (2025/26 kits)
                     No 'p' prefix. All 36 FPL squad members covered — zero misses.
...
Squad sourced from:
  https://www.espn.com/soccer/team/squad/_/id/357/leeds-united
"""
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_ROSTER_API  = (
    "https://site.api.espn.com/apis/site/v2/sports/soccer/eng.1/teams/357/roster"
)
...
TM_KADER_URL     = "https://www.transfermarkt.com/leeds-united/kader/verein/399"

OUTPUT_DIR = Path("f:/logo/leeds_united_soccer_player_logos")
...
def build_espn_roster() -> list[dict]:
    players = []
    try:
        print("  Fetching ESPN roster (team 357 / eng.1) ...")
...
def build_fpl_lookup() -> dict:
    """
    Returns {normalized_name: best_photo_url} for every Leeds player in FPL.
...
def main() -> None:
    ...
    print("=" * 60)
    print("  Leeds United FC — Player Headshot Scraper")
    print("=" * 60)
