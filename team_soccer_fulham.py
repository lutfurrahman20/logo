"""
Fulham FC — Player Headshot Downloader (Soccer / EPL)
...
Sources (tried in order per player):
  1. PL25 CDN      — resources.premierleague.com/premierleague25/110x140 (2025/26 kits)
                     No 'p' prefix. Covers 28 squad members in current Fulham kit.
  2. FPL CDN       — resources.premierleague.com/premierleague/110x140 (legacy fallback).
  3. Transfermarkt — img.a.transfermarkt.technology portrait photos (24 players).
...
Squad sourced from:
  https://www.espn.com/soccer/team/squad/_/id/370/fulham
"""
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_ROSTER_API  = (
    "https://site.api.espn.com/apis/site/v2/sports/soccer/eng.1/teams/370/roster"
)
...
TM_KADER_URL     = "https://www.transfermarkt.com/fc-fulham/kader/verein/931"

OUTPUT_DIR = Path("f:/logo/fulham_soccer_player_logos")
...
ESPN_TO_FPL_NAME: dict[str, str] = {
    # "Kevin" is Kevin Mbabu — FPL may store full name
    "Kevin": "Kevin Méndez",
}
...
def build_espn_roster() -> list[dict]:
    players = []
    try:
        print("  Fetching ESPN roster (team 370 / eng.1) ...")
...
def build_fpl_lookup() -> dict:
    """
    Returns {normalized_name: best_photo_url} for every Fulham player in FPL.
...
def main() -> None:
    ...
    print("=" * 60)
    print("  Fulham FC — Player Headshot Scraper")
    print("=" * 60)
