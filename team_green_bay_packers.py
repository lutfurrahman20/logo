"""
Green Bay Packers - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/gb/roster"
OUTPUT_DIR = Path("f:/logo/packers_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Packers roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  GREEN BAY PACKERS - Active Player Headshot Scraper")
    print("=" * 60)
