"""
Tampa Bay Buccaneers - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/tb/roster"
OUTPUT_DIR = Path("f:/logo/buccaneers_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  TAMPA BAY BUCCANEERS - Active Player Headshot Scraper")
    print("=" * 60)
