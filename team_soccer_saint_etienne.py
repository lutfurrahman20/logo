"""
AS Saint-Étienne — Player Headshot Downloader (Soccer / Ligue 2)

Sources (tried in order per player):
  1. ESPN CDN      — a.espncdn.com headshots
  2. Transfermarkt — portrait photos (verein/618)

Squad sourced from:
  https://www.espn.com/soccer/team/squad/_/id/178/saint-etienne
"""
...
ESPN_ROSTER_API = "https://site.api.espn.com/apis/site/v2/sports/soccer/fra.2/teams/178/roster"
ESPN_HEADSHOT   = "https://a.espncdn.com/i/headshots/soccer/players/full/{id}.png"
TM_KADER_URL    = "https://www.transfermarkt.com/as-saint-etienne/kader/verein/618"
OUTPUT_DIR      = Path("f:/logo/saint_etienne_soccer_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  AS Saint-Étienne — Player Headshot Scraper")
    print("=" * 60)
