"""
Calgary Stampeders (CFL) - Player Headshot Scraper (CFL)
...
TEAM_ABBR  = "CGY"
OUTPUT_DIR = Path("f:/logo/cfl_stampeders_player_logos")
...
def main():
    ...
    print("=" * 60)
    print(f"  Calgary Stampeders (CFL) - Player Headshot Scraper")
    print("=" * 60)
