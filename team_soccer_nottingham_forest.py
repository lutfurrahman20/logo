"""
Nottingham Forest FC — Player Headshot Downloader (Soccer / EPL)
...
Sources (tried in order per player):
  1. PL25 CDN      — resources.premierleague.com/premierleague25/110x140 (2025/26 kits)
                     No 'p' prefix. Covers 35 of 39 FPL squad members.
  2. FPL CDN       — resources.premierleague.com/premierleague/110x140 (legacy fallback).
  3. Transfermarkt — img.a.transfermarkt.technology portrait photos (29 players).
...
Squad sourced from:
  https://www.espn.com/soccer/team/squad/_/id/393/nottingham-forest
"""
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_ROSTER_API  = (
    "https://site.api.espn.com/apis/site/v2/sports/soccer/eng.1/teams/393/roster"
)
...
TM_KADER_URL     = "https://www.transfermarkt.com/nottingham-forest/kader/verein/703"

OUTPUT_DIR = Path("f:/logo/nottingham_forest_soccer_player_logos")
...
def build_espn_roster() -> list[dict]:
    players = []
    try:
        print("  Fetching ESPN roster (team 393 / eng.1) ...")
...
def main() -> None:
    ...
    print("=" * 60)
    print("  Nottingham Forest FC — Player Headshot Scraper")
    print("=" * 60)
