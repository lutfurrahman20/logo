"""
Kansas City Chiefs - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/kc/roster"
OUTPUT_DIR = Path("f:/logo/chiefs_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Chiefs roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  KANSAS CITY CHIEFS - Active Player Headshot Scraper")
    print("=" * 60)
