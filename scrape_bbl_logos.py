"""
ESPN Big Bash League (Cricket) Team Logo Downloader
Fetches team logos from ESPN CDN for all 8 BBL teams.
...
OUTPUT_DIR = Path("f:/logo/bbl_logos")
API_URL = "https://site.web.api.espn.com/apis/v2/sports/cricket/8044/standings"
LEAGUE_NAME = "Big Bash League"


def fetch_teams() -> list[dict]:
    """Fetch BBL teams from ESPN standings API."""
...
def main():
    ...
    print("=" * 60)
    print("ESPN Big Bash League Logo Downloader")
    print("=" * 60)
