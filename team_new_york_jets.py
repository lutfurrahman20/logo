"""
New York Jets - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/nyj/roster"
OUTPUT_DIR = Path("f:/logo/jets_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  NEW YORK JETS - Active Player Headshot Scraper")
    print("=" * 60)
