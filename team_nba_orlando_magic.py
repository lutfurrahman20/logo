"""
Orlando Magic - Active Player Headshot Scraper (NBA)
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/basketball/nba/teams/19/roster"
OUTPUT_DIR = Path("f:/logo/magic_nba_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  Orlando Magic (NBA) - Active Player Headshot Scraper")
    print("=" * 60)
