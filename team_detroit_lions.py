"""
Detroit Lions - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/det/roster"
OUTPUT_DIR = Path("f:/logo/lions_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Lions roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  DETROIT LIONS - Active Player Headshot Scraper")
    print("=" * 60)
