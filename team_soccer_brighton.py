"""
Brighton & Hove Albion FC — Player Headshot Downloader (Soccer / EPL)
...
Sources (tried in order per player):
  1. PL25 CDN      — resources.premierleague.com/premierleague25/110x140 (2025/26 kits)
                     No 'p' prefix. Covers 41 squad members in current Brighton kit.
...
Squad sourced from:
  https://www.espn.com/soccer/team/squad/_/id/331/brighton-hove-albion
"""
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_ROSTER_API  = (
    "https://site.api.espn.com/apis/site/v2/sports/soccer/eng.1/teams/331/roster"
)
...
TM_KADER_URL     = "https://www.transfermarkt.com/brighton-amp-hove-albion/kader/verein/1237"

OUTPUT_DIR = Path("f:/logo/brighton_hove_albion_soccer_player_logos")
...
ESPN_TO_FPL_NAME: dict[str, str] = {
    # Add overrides here if ESPN name differs from FPL name
}
...
def build_espn_roster() -> list[dict]:
    players = []
    try:
        print("  Fetching ESPN roster (team 331 / eng.1) ...")
...
def build_fpl_lookup() -> dict:
    """
    Returns {normalized_name: best_photo_url} for every Brighton player in FPL.
...
def main() -> None:
    ...
    print("=" * 60)
    print("  Brighton & Hove Albion FC — Player Headshot Scraper")
    print("=" * 60)
