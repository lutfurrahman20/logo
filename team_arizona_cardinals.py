"""
Arizona Cardinals - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/ari/roster"
OUTPUT_DIR = Path("f:/logo/cardinals_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Cardinals roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  ARIZONA CARDINALS - Active Player Headshot Scraper")
    print("=" * 60)
