"""
Buffalo Bills - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/buf/roster"
OUTPUT_DIR = Path("f:/logo/bills_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Bills roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  BUFFALO BILLS - Active Player Headshot Scraper")
    print("=" * 60)
