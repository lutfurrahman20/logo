"""
Philadelphia Eagles - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/phi/roster"
OUTPUT_DIR = Path("f:/logo/eagles_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  PHILADELPHIA EAGLES - Active Player Headshot Scraper")
    print("=" * 60)
