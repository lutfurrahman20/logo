"""
Toronto Raptors - Active Player Headshot Scraper (NBA)
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/basketball/nba/teams/28/roster"
OUTPUT_DIR = Path("f:/logo/raptors_nba_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  Toronto Raptors (NBA) - Active Player Headshot Scraper")
    print("=" * 60)
