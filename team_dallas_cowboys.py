"""
Dallas Cowboys - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/dal/roster"
OUTPUT_DIR = Path("f:/logo/cowboys_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Cowboys roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  DALLAS COWBOYS - Active Player Headshot Scraper")
    print("=" * 60)
