"""
Las Vegas Raiders - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/lv/roster"
OUTPUT_DIR = Path("f:/logo/raiders_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Raiders roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  LAS VEGAS RAIDERS - Active Player Headshot Scraper")
    print("=" * 60)
