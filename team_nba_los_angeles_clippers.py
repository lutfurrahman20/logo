"""
Los Angeles Clippers - Active Player Headshot Scraper (NBA)
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/basketball/nba/teams/12/roster"
OUTPUT_DIR = Path("f:/logo/clippers_nba_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  Los Angeles Clippers (NBA) - Active Player Headshot Scraper")
    print("=" * 60)
