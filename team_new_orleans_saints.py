"""
New Orleans Saints - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/no/roster"
OUTPUT_DIR = Path("f:/logo/saints_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  NEW ORLEANS SAINTS - Active Player Headshot Scraper")
    print("=" * 60)
