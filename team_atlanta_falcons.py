"""
Atlanta Falcons - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/atl/roster"
OUTPUT_DIR = Path("f:/logo/falcons_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Falcons roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  ATLANTA FALCONS - Active Player Headshot Scraper")
    print("=" * 60)
