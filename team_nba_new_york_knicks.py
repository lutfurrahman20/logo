"""
New York Knicks - Active Player Headshot Scraper (NBA)
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/basketball/nba/teams/18/roster"
OUTPUT_DIR = Path("f:/logo/knicks_nba_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  New York Knicks (NBA) - Active Player Headshot Scraper")
    print("=" * 60)
