"""
Minnesota Vikings - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/min/roster"
OUTPUT_DIR = Path("f:/logo/vikings_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Vikings roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  MINNESOTA VIKINGS - Active Player Headshot Scraper")
    print("=" * 60)
