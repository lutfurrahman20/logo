"""
Washington Commanders - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/wsh/roster"
OUTPUT_DIR = Path("f:/logo/commanders_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  WASHINGTON COMMANDERS - Active Player Headshot Scraper")
    print("=" * 60)
