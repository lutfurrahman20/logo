"""
Saskatchewan Roughriders (CFL) - Player Headshot Scraper (CFL)
...
TEAM_ABBR  = "SSK"
OUTPUT_DIR = Path("f:/logo/cfl_roughriders_player_logos")
...
def main():
    ...
    print("=" * 60)
    print(f"  Saskatchewan Roughriders (CFL) - Player Headshot Scraper")
    print("=" * 60)
