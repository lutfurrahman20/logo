"""
Montreal Alouettes (CFL) - Player Headshot Scraper (CFL)
...
TEAM_ABBR  = "MTL"
OUTPUT_DIR = Path("f:/logo/cfl_alouettes_player_logos")
...
def main():
    ...
    print("=" * 60)
    print(f"  Montreal Alouettes (CFL) - Player Headshot Scraper")
    print("=" * 60)
