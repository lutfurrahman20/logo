"""
Brooklyn Nets - Active Player Headshot Scraper (NBA)
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/basketball/nba/teams/17/roster"
OUTPUT_DIR = Path("f:/logo/nets_nba_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  Brooklyn Nets (NBA) - Active Player Headshot Scraper")
    print("=" * 60)
