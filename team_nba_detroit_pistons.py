"""
Detroit Pistons - Active Player Headshot Scraper (NBA)
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/basketball/nba/teams/8/roster"
OUTPUT_DIR = Path("f:/logo/pistons_nba_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  Detroit Pistons (NBA) - Active Player Headshot Scraper")
    print("=" * 60)
