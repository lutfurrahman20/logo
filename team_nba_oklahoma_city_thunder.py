"""
Oklahoma City Thunder - Active Player Headshot Scraper (NBA)
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/basketball/nba/teams/25/roster"
OUTPUT_DIR = Path("f:/logo/thunder_nba_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  Oklahoma City Thunder (NBA) - Active Player Headshot Scraper")
    print("=" * 60)
