"""
Houston Rockets - Active Player Headshot Scraper (NBA)
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/basketball/nba/teams/10/roster"
OUTPUT_DIR = Path("f:/logo/rockets_nba_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  Houston Rockets (NBA) - Active Player Headshot Scraper")
    print("=" * 60)
