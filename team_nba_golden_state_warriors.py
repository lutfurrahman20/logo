"""
Golden State Warriors - Active Player Headshot Scraper (NBA)
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/basketball/nba/teams/9/roster"
OUTPUT_DIR = Path("f:/logo/warriors_nba_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  Golden State Warriors (NBA) - Active Player Headshot Scraper")
    print("=" * 60)
