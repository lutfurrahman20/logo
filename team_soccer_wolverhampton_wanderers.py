"""
Wolverhampton Wanderers FC — Player Headshot Downloader (Soccer / EPL)
...
Sources (tried in order per player):
  1. PL25 CDN      — resources.premierleague.com/premierleague25/110x140 (2025/26 kits)
                     No 'p' prefix. Covers 33 of 43 FPL squad members.
  2. FPL CDN       — resources.premierleague.com/premierleague/110x140 (legacy fallback).
  3. Transfermarkt — img.a.transfermarkt.technology portrait photos (23 players).
...
Squad sourced from:
  https://www.espn.com/soccer/team/squad/_/id/380/wolverhampton-wanderers
"""
...
TM_KADER_URL     = "https://www.transfermarkt.com/wolverhampton-wanderers/kader/verein/543"

OUTPUT_DIR = Path("f:/logo/wolverhampton_wanderers_soccer_player_logos")
...
def build_espn_roster() -> list[dict]:
    players = []
    try:
        print("  Fetching ESPN roster (team 380 / eng.1) ...")
...
def main() -> None:
    ...
    print("=" * 60)
    print("  Wolverhampton Wanderers FC — Player Headshot Scraper")
    print("=" * 60)
