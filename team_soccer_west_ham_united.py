"""
West Ham United FC — Player Headshot Downloader (Soccer / EPL)
...
Sources (tried in order per player):
  1. PL25 CDN      — resources.premierleague.com/premierleague25/110x140 (2025/26 kits)
                     No 'p' prefix. Covers 37 of 41 FPL squad members.
...
Squad sourced from:
  https://www.espn.com/soccer/team/squad/_/id/371/west-ham-united
"""
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_ROSTER_API    = (
    "https://site.api.espn.com/apis/site/v2/sports/soccer/eng.1/teams/371/roster"
)
...
TM_KADER_URL       = "https://www.transfermarkt.com/west-ham-united/kader/verein/379"

OUTPUT_DIR = Path("f:/logo/west_ham_united_soccer_player_logos")
...
def build_espn_roster() -> list[dict]:
    players = []
    try:
        print("  Fetching ESPN roster (team 371 / eng.1) ...")
...
def main() -> None:
    ...
    print("=" * 60)
    print("  West Ham United FC — Player Headshot Scraper")
    print("=" * 60)
