"""
ESPN Pakistan Super League (Cricket) Team Logo Downloader
Fetches team logos from ESPN CDN for all PSL teams.
Falls back to TheSportsDB, then Wikipedia when ESPN has no logo.
Source: https://www.espn.com/cricket/standings/sort/matchpoints/dir/asc/series/8679/psl
...
OUTPUT_DIR = Path("f:/logo/psl_logos")
API_URL = "https://site.web.api.espn.com/apis/v2/sports/cricket/8679/standings"
LEAGUE_NAME = "Pakistan Super League"

TSDB_ALIASES = {
    "Rawalpindiz": ["Pindiz", "Rawalpindi"],
    "Hyderabad Kingsmen": ["Hyderabad Houston Kingsmen", "Hyderabad"],
}


def fetch_teams() -> list[dict]:
    """Fetch all unique PSL teams from ESPN standings API."""
...
def main():
    ...
    print("=" * 60)
    print("ESPN Pakistan Super League Logo Downloader")
    print("=" * 60)
    ...
    for team in teams:
        ...
        success, source = download_with_fallbacks(
            ...
            save_path,
            league=LEAGUE_NAME,
            tsdb_aliases=TSDB_ALIASES.get(team["name"]),
