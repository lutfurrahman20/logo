"""
Los Angeles Lakers - Active Player Headshot Scraper (NBA)
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/basketball/nba/teams/13/roster"
OUTPUT_DIR = Path("f:/logo/lakers_nba_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  Los Angeles Lakers (NBA) - Active Player Headshot Scraper")
    print("=" * 60)
