"""
Cleveland Browns - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/cle/roster"
OUTPUT_DIR = Path("f:/logo/browns_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Browns roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  CLEVELAND BROWNS - Active Player Headshot Scraper")
    print("=" * 60)
