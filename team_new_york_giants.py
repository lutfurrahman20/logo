"""
New York Giants - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/nyg/roster"
OUTPUT_DIR = Path("f:/logo/giants_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  NEW YORK GIANTS - Active Player Headshot Scraper")
    print("=" * 60)
