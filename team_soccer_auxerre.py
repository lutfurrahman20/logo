"""
AJ Auxerre — Player Headshot Downloader (Soccer / Ligue 1)

Sources (tried in order per player):
  1. ESPN CDN      — a.espncdn.com headshots
  2. Transfermarkt — portrait photos (verein/290)

Squad sourced from:
  https://www.espn.com/soccer/team/squad/_/id/172/aj-auxerre
"""
...
ESPN_ROSTER_API = "https://site.api.espn.com/apis/site/v2/sports/soccer/fra.1/teams/172/roster"
ESPN_HEADSHOT   = "https://a.espncdn.com/i/headshots/soccer/players/full/{id}.png"
TM_KADER_URL    = "https://www.transfermarkt.com/aj-auxerre/kader/verein/290"
OUTPUT_DIR      = Path("f:/logo/auxerre_soccer_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  AJ Auxerre — Player Headshot Scraper")
    print("=" * 60)
