"""
Tennessee Titans - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/ten/roster"
OUTPUT_DIR = Path("f:/logo/titans_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  TENNESSEE TITANS - Active Player Headshot Scraper")
    print("=" * 60)
