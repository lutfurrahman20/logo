"""
New Orleans Pelicans - Active Player Headshot Scraper (NBA)
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/basketball/nba/teams/3/roster"
OUTPUT_DIR = Path("f:/logo/pelicans_nba_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  New Orleans Pelicans (NBA) - Active Player Headshot Scraper")
    print("=" * 60)
