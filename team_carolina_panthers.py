"""
Carolina Panthers - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/car/roster"
OUTPUT_DIR = Path("f:/logo/panthers_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Panthers roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  CAROLINA PANTHERS - Active Player Headshot Scraper")
    print("=" * 60)
