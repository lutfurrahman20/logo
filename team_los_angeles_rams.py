"""
Los Angeles Rams - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/lar/roster"
OUTPUT_DIR = Path("f:/logo/rams_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Rams roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  LOS ANGELES RAMS - Active Player Headshot Scraper")
    print("=" * 60)
