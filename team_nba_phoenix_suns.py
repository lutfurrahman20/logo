"""
Phoenix Suns - Active Player Headshot Scraper (NBA)
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/basketball/nba/teams/21/roster"
OUTPUT_DIR = Path("f:/logo/suns_nba_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  Phoenix Suns (NBA) - Active Player Headshot Scraper")
    print("=" * 60)
