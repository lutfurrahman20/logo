"""
Atlanta Braves - Full Roster Player Headshot Scraper (MLB)
...
# ── Config ─────────────────────────────────────────────────────────────────────
MLB_ROSTER_API  = "https://statsapi.mlb.com/api/v1/teams/144/roster/40Man"
ESPN_ROSTER_API = "https://site.api.espn.com/apis/site/v2/sports/baseball/mlb/teams/15/roster"
ESPN_SEARCH_API = "https://site.api.espn.com/apis/search/v2"
OUTPUT_DIR      = Path("f:/logo/atlanta_braves_mlb_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  Atlanta Braves (MLB) - Full Roster Headshot Scraper")
    print("=" * 60)
