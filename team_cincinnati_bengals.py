"""
Cincinnati Bengals - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/cin/roster"
OUTPUT_DIR = Path("f:/logo/bengals_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Bengals roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  CINCINNATI BENGALS - Active Player Headshot Scraper")
    print("=" * 60)
