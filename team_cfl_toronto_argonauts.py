"""
Toronto Argonauts (CFL) - Player Headshot Scraper (CFL)
...
TEAM_ABBR  = "TOR"
OUTPUT_DIR = Path("f:/logo/cfl_argonauts_player_logos")
...
def main():
    ...
    print("=" * 60)
    print(f"  Toronto Argonauts (CFL) - Player Headshot Scraper")
    print("=" * 60)
