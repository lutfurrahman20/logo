"""
Miami Heat - Active Player Headshot Scraper (NBA)
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/basketball/nba/teams/14/roster"
OUTPUT_DIR = Path("f:/logo/heat_nba_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  Miami Heat (NBA) - Active Player Headshot Scraper")
    print("=" * 60)
