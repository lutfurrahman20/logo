"""
San Antonio Spurs - Active Player Headshot Scraper (NBA)
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/basketball/nba/teams/24/roster"
OUTPUT_DIR = Path("f:/logo/spurs_nba_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  San Antonio Spurs (NBA) - Active Player Headshot Scraper")
    print("=" * 60)
