"""
Jacksonville Jaguars - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/jax/roster"
OUTPUT_DIR = Path("f:/logo/jaguars_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Jaguars roster from the ESPN API.
...
def upgrade_url(url: str) -> str:
    """Strip ESPN combiner query args to get the full-size PNG."""
...
def main():
    ...
    print("=" * 60)
    print("  JACKSONVILLE JAGUARS - Active Player Headshot Scraper")
    print("=" * 60)
