"""
Baltimore Ravens - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/bal/roster"
OUTPUT_DIR = Path("f:/logo/ravens_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Ravens roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  BALTIMORE RAVENS - Active Player Headshot Scraper")
    print("=" * 60)
