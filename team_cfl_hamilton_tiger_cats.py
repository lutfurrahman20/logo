"""
Hamilton Tiger-Cats (CFL) - Player Headshot Scraper (CFL)
...
TEAM_ABBR  = "HAM"
OUTPUT_DIR = Path("f:/logo/cfl_tiger_cats_player_logos")
...
def main():
    ...
    print("=" * 60)
    print(f"  Hamilton Tiger-Cats (CFL) - Player Headshot Scraper")
    print("=" * 60)
