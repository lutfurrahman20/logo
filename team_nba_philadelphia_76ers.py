"""
Philadelphia 76ers - Active Player Headshot Scraper (NBA)
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/basketball/nba/teams/20/roster"
OUTPUT_DIR = Path("f:/logo/76ers_nba_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  Philadelphia 76ers (NBA) - Active Player Headshot Scraper")
    print("=" * 60)
