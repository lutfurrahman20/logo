"""
AS Monaco — Player Headshot Downloader (Soccer / Ligue 1)
...
Squad sourced from:
  https://www.espn.com/soccer/team/squad/_/id/174/as-monaco
"""
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_ROSTER_API = (
    "https://site.api.espn.com/apis/site/v2/sports/soccer/fra.1/teams/174/roster"
)
ESPN_HEADSHOT   = "https://a.espncdn.com/i/headshots/soccer/players/full/{id}.png"

TM_KADER_URL    = "https://www.transfermarkt.com/as-monaco-fc/kader/verein/162"

OUTPUT_DIR = Path("f:/logo/monaco_soccer_player_logos")
...
def build_espn_roster() -> list[dict]:
    players = []
    try:
        print("  Fetching ESPN roster (team 174 / fra.1) ...")
...
def main() -> None:
    ...
    print("=" * 60)
    print("  AS Monaco — Player Headshot Scraper")
    print("=" * 60)
