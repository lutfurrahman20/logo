"""
Portland Trail Blazers - Active Player Headshot Scraper (NBA)
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/basketball/nba/teams/22/roster"
OUTPUT_DIR = Path("f:/logo/trail_blazers_nba_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  Portland Trail Blazers (NBA) - Active Player Headshot Scraper")
    print("=" * 60)
