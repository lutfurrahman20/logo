"""
Boston Red Sox - Full Roster Player Headshot Scraper (MLB)
...
# ── Config ─────────────────────────────────────────────────────────────────────
MLB_ROSTER_API  = "https://statsapi.mlb.com/api/v1/teams/111/roster/40Man"
ESPN_ROSTER_API = "https://site.api.espn.com/apis/site/v2/sports/baseball/mlb/teams/2/roster"
ESPN_SEARCH_API = "https://site.api.espn.com/apis/search/v2"
OUTPUT_DIR      = Path("f:/logo/boston_red_sox_mlb_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  Boston Red Sox (MLB) - Full Roster Headshot Scraper")
    print("=" * 60)
