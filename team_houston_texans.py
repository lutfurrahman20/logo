"""
Houston Texans - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/hou/roster"
OUTPUT_DIR = Path("f:/logo/texans_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Texans roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  HOUSTON TEXANS - Active Player Headshot Scraper")
    print("=" * 60)
