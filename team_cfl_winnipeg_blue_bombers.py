"""
Winnipeg Blue Bombers (CFL) - Player Headshot Scraper (CFL)
...
TEAM_ABBR  = "WPG"
OUTPUT_DIR = Path("f:/logo/cfl_blue_bombers_player_logos")
...
def main():
    ...
    print("=" * 60)
    print(f"  Winnipeg Blue Bombers (CFL) - Player Headshot Scraper")
    print("=" * 60)
