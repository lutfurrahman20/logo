"""
Denver Broncos - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/den/roster"
OUTPUT_DIR = Path("f:/logo/broncos_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Broncos roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  DENVER BRONCOS - Active Player Headshot Scraper")
    print("=" * 60)
