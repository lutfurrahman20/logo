"""
Pittsburgh Steelers - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/pit/roster"
OUTPUT_DIR = Path("f:/logo/steelers_player_logos")
...
def main():
    ...
    print("=" * 60)
    print("  PITTSBURGH STEELERS - Active Player Headshot Scraper")
    print("=" * 60)
