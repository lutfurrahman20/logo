"""
Indianapolis Colts - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/ind/roster"
OUTPUT_DIR = Path("f:/logo/colts_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Colts roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  INDIANAPOLIS COLTS - Active Player Headshot Scraper")
    print("=" * 60)
