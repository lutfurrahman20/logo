...
# Comprehensive list of all handball leagues
HANDBALL_LEAGUES = [
    # International
    ...
    # Other European
    "Hungarian Handball League",
    "Polish Handball League",
    "Romanian Handball League",
    "Croatian Handball League",
    "Slovenian Handball League",
    "Austrian Handball League",
    "Swiss Handball League",
    "Czech Handball League",
...
def download_league_logos(league_name):
    ...
    try:
        ...
        # Download logos
        logos_folder = f"handball_logos/{safe_league_name}"
...
if __name__ == "__main__":
    print("\n" + "="*70)
    print("🤾 SCRAPING ALL HANDBALL LEAGUES")
    print("="*70)
    print(f"\nTotal leagues to scrape: {len(HANDBALL_LEAGUES)}")
    print("This will take a few minutes...\n")
    
    # Create summary
    summary = {
        "total_leagues": len(HANDBALL_LEAGUES),
        "successful_leagues": 0,
        "total_teams": 0,
        "leagues": []
    }
    
    for i, league in enumerate(HANDBALL_LEAGUES, 1):
        print(f"\n[{i}/{len(HANDBALL_LEAGUES)}] Processing: {league}")
        ...
        if i < len(HANDBALL_LEAGUES):
            time.sleep(1.5)
    
    # Save summary
    with open("handball_scraping_summary.json", "w", encoding="utf-8") as f:
        json.dump(summary, f, indent=2, ensure_ascii=False)
    
    print("\n" + "="*70)
    print("🎉 HANDBALL SCRAPING COMPLETE!")
    print("="*70)
    ...
    print(f"\n📁 Logos saved in: handball_logos/")
    print(f"📄 Data saved in: handball_data/")
    print(f"📊 Summary saved: handball_scraping_summary.json")
    print("="*70 + "\n")
