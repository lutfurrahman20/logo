"""
Chicago Bears - ACTIVE Player Headshot Scraper
...
# ── Config ─────────────────────────────────────────────────────────────────────
ESPN_API   = "https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams/chi/roster"
OUTPUT_DIR = Path("f:/logo/bears_player_logos")
...
def get_active_players() -> list[dict]:
    """
    Fetch Bears roster from the ESPN API.
...
def main():
    ...
    print("=" * 60)
    print("  CHICAGO BEARS - Active Player Headshot Scraper")
    print("=" * 60)
